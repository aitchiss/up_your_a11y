...
In this article we’re going to step through a very simple layout, re-organise it to make it more accessible, and then finally add some extra enhancements with HTML5 semantic elements.
...
We can change the header and footer elements from a div to their corresponding HTML5 tags, to clearly mark them out to screen readers, and similarly our main content can be wrapped in the appropriate main tag.
