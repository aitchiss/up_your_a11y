...
category: 'react'
description: 'Without explicitly managing it, the page title in your React app will never change. Find out how this affects diverse users, and a method to manage your page titles.'
accentColor: '#BFE3D2'
sortOrder: 1
...
W3C has some excellent [tips on page titles](https://www.w3.org/WAI/WCAG21/Techniques/general/G88.html), which are summarised below.
