---
title: 'Top Tools for Developing With Accessibility in Mind'
displayTitle: 'Set Up Your Tooling'
...
accentColor: '#7EB6D7'
sortOrder: 3
artUrl: '/fundamentals-article-art-3.png'
keyTakeaways:
...
readingList:
  - url: 'https://www.w3.org/WAI/ER/tools/'
    description: 'WCAG Web Accessibility Evaluation Tools List'
  - url: 'https://a11yproject.com/resources/'
    description: "The A11y Project's pick of resources"
keywords:
  - 'development tools'
  - 'dev tools'
  - 'accessibility lint'
...
Writing accessible code can be made so much easier by leveraging some popular tools. This topic covers 5 favourites, plus a few more that you might like to try out. If there’s a great tool you think is missing, please do <Link to="/contact">get in touch</Link>!
...
The plugin is great at picking up certain types of errors, e.g. a missing label for a form field, an aria-role value that isn’t valid, and so on. It’s a thorough initial check on your code that will save plenty time in testing down the line. The best part is, if you use a CI tool like Jenkins or Bitbucket Pipelines, you can ensure that the lint is run as part of your CI process, making sure that no errors make their way into your production code.

<a href="https://www.npmjs.com/package/eslint-plugin-jsx-a11y">Visit the NPM repository for JSX A11y</a>

### 2. Axe Chrome Extension

Axe is an excellent tool to follow on from linting with jsx-a11y. The Axe extension can be used during development in Chrome, and analyses the current page for accessibility issues. It’s great for picking up problem areas like lack of page landmarks, contrast issues, heading levels increasing inconsistently, and so on.

Happily, it also provides tips on how to fix the issues found, as well as linking out to more detailed explanations and the related WCAG guidelines. The ‘inspect node’ link quickly takes you to the offending part of your page for further inspection.
...
<a href="https://chrome.google.com/webstore/detail/axe/lhdoppojpmngadmnindnejefpokejbdd">Download the Axe Chrome Extension</a>
...
<a href="https://chrome.google.com/webstore/detail/wave-evaluation-tool/jbbplnpkjmmeebjpijfedlgcdilocofh">Download the Wave Chrome Extension</a>

![Wave Chrome Extension](./WaveHeaders.png)

### 4. Contrast Checker

Using Wave or Axe, it’s likely that you’ll come across some color contrast issues from time to time, and this Contrast Checker is one of many tools that will check your color combinations against the WCAG 2.0 guidelines.

This tool is particularly recommended, as unlike many other contrast checkers it also allows you to view the colour combination in grayscale, and select your colours from an image. This can be handy if you’re quickly checking a design and don’t have the exact hex colours yet.
...
<a href="https://contrastchecker.com/">Visit the Contrast Checker website</a>

![Contrast Checker Tool](./ContrastChecker.png)

### 5. Accessibility Support

Accessibility Support is very similar in principle to the much used <a href="https://caniuse.com/">Can I Use</a> website, only for accessibility specifically. You can search for a particular element or attribute, and get a quick rundown of which assistive technologies are known to support it. It's a great time saver to prevent cross-platform issues, e.g. if a feature is supported in VoiceOver on MacOS but not on NVDA/Windows. The project is community-drive and open-source, so it’s possible to raise an issue or contribute if you can.

<a href="https://a11ysupport.io/">Visit the A11y Support Page</a>

### And some extras…

#### Firefox Accessibility Tree Inspector

This facility is available in Chrome also, but Firefox takes the win for most friendly UI. To view a page’s accessibility tree, open the developer tools and click on the Accessibility tab. The accessibility tree gives you a nice overview of how assistive technology is going to traverse your page, and the relevant information for each element e.g. what state an element is in or what role it has. There’s a great summary on Mozilla Hacks explaining [the uses for accessibility trees](https://hacks.mozilla.org/2019/06/how-accessibility-trees-inform-assistive-tech/).

![Firefox Accessibility Tree Example](./FirefoxTree.png)

### Color Oracle

A free color blindness simulator for Mac users, that will allow you to see how users with common types of color blindness will view your site. Not something you will need for day to day development, but certainly interesting to check out, especially given as many as 8% of men (and 0.5% of women) have some form of color blindness.

<a href="https://colororacle.org/">Download Color Oracle for Mac</a>
